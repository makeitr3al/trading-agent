...
class DecisionAction(str, Enum):
    ...
    CLOSE_TREND_TRADE = "CLOSE_TREND_TRADE"
    CLOSE_COUNTERTREND_TRADE = "CLOSE_COUNTERTREND_TRADE"
    ADJUST_TREND_STOP_TO_LAST_CLOSE = "ADJUST_TREND_STOP_TO_LAST_CLOSE"
    ADJUST_TREND_STOP_TO_SIGNAL_BAR_CLOSE = "ADJUST_TREND_STOP_TO_SIGNAL_BAR_CLOSE"
