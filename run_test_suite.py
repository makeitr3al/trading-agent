        ...
        "steps": [
            {
                ...
                "command": [
                    ...
                    "tests/test_trading_app_cycle.py",
                    "tests/test_trading_app_guards.py",
                    "tests/test_trading_app_trades.py",
                    "tests/test_trading_app_limits.py",
                    "tests/test_state_sync_mapping.py",
                    "tests/test_state_sync_build.py",
                    "tests/test_state_sync_client.py",
